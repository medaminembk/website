        ...
        if (!formValid) {
            ...
            return (
                <>
                    ...
                    <div className="card shadow-sm border-0 px-3 rounded-2 mb-3 py-4 mx-auto mt-5 bg-info">
                        ...
                        <div className="card-body">
                            <form action="/" onSubmit={(e) => this.handleSubmit(e)} encType="multipart/form-data" autoComplete="off">
                                <div className="form-group text-left">
                                    <label className="mb-0 text-left">Name<span className="text-danger">*</span></label>
                                ...
                                <p className="text-center mb-0"><input type="submit" className="btn btn-light btn-lg w-100 text-uppercase mt-3" value="Submit Now" /></p>
                            </form>
